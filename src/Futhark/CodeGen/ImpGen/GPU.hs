...
compileProgOpenCL :: MonadFreshNames m => Prog GPUMem -> m (Warnings, Imp.Program)
compileProgOpenCL = compileProg $ HostEnv openclAtomics OpenCL mempty

compileProgCUDA :: MonadFreshNames m => Prog GPUMem -> m (Warnings, Imp.Program)
compileProgCUDA = compileProg $ HostEnv cudaAtomics CUDA mempty

compileProgCUEW :: MonadFreshNames m => Prog GPUMem -> m (Warnings, Imp.Program)
compileProgCUEW = compileProg $ HostEnv cudaAtomics CUEW mempty
